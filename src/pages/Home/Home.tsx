        ...
        <div className="flex-container">
          <div className="flex-1 user-container flex-container flex-item-algin-center">
            ...
            >
              <div className="flex-container">
                <div>
                  <Icon style={{ fontSize: 50, marginRight: 24 }} type="solution" />
                </div>
                <div>
                  <h1>139****3130</h1>
                  未认证
              ...
              <Col md={24} lg={8}>
                <div className="flex-container flex-item-algin-center">
                  <div className="prod-logo">
                    <img src="//static0.qxwz.com/cms/common/icon2-qxwz-findcm-o.png" alt="icon" />
                  </div>
                  <div>
